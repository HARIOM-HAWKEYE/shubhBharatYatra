...
const Marquee = () => {
  ...
  return (
    <div className="hidden sm:block overflow-hidden whitespace-nowrap border absolute sm:bottom-[100px] md:bottom-[100px] lg:bottom-[9px] z-10 bg-black w-[80%] rounded-[50px] max-w-[1200px] left-1/2 transform -translate-x-1/2">
